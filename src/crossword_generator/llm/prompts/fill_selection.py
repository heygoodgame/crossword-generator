...
def build_fill_selection_prompt(
    ...
    return (
        ...
        "angles — wordplay, misdirection, cultural references. Prefer "
        "entries that can be clued through everyday meanings or widely shared "
        "knowledge. Penalize entries that only work as dated pop-culture, "
        "celebrity, entertainment, sports, brand, or historical references "
        "unless they are cross-generationally iconic. The older or more niche "
        "a reference is, the more famous it must be.\n\n"
        ...
        "5. FAMILY-FRIENDLY: Reject any board containing profanity, "
        "vulgar slang, sexual innuendo, slurs, or anything not suitable "
        "for all ages. A single offensive entry should disqualify the board.\n\n"
