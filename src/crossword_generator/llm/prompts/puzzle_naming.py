...
_GUIDELINES = (
    ...
    "- The title must NOT contain an answer word or any lexical variation "
    "of one from the grid (plural, tense, comparative, shared root, etc.)\n"
    ...
    "fill\n"
    "- Be especially careful with titles inspired by 1-Across: the "
    "title should not sexualize, objectify, or wink at a potentially "
    "sensitive answer\n"
    "- Prefer neutral, broadly welcoming titles. When in doubt, choose "
    "a plain non-jokey title over a clever title that could read as "
    "insensitive\n"
    '- Bad example: "Cheeky Support" to hint at BRA. The answer may '
    "be clueable, but the title frames it in a way some solvers may "
    "find insensitive.\n"
