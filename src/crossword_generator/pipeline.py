...
def create_pipeline(
    ...
    *,
    ...
    if config.llm.provider == "ollama":
        ...
        clue_repair_llm = _claude_for("clue_repair")
    ...
    clue_repair_llm = _with_llm_logging("clue_repair", clue_repair_llm)
